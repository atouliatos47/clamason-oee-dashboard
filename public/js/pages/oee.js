            ...
            <div style="font-size:11px;font-weight:700;color:#888;text-transform:uppercase;letter-spacing:.5px;margin-bottom:6px">
                ...
                <span style="float:right;display:flex;align-items:center;gap:14px;font-size:11px;font-weight:700;color:#243547">
                    <span style="display:flex;align-items:center;gap:5px">
                        <span style="width:28px;height:4px;background:#95C11F;border-radius:2px;display:inline-block"></span>Availability
                    </span>
                    <span style="display:flex;align-items:center;gap:5px">
                        <span style="width:28px;height:2px;background:#243547;border-radius:2px;display:inline-block;border-top:2px dashed #243547"></span>OEE
                    </span>
                    <span style="display:flex;align-items:center;gap:5px">
                        <span style="width:28px;height:2px;background:#e67e22;border-radius:2px;display:inline-block;border-top:2px dashed #e67e22"></span>Perf
                    </span>
                    <span style="display:flex;align-items:center;gap:5px">
                        <span style="width:28px;height:2px;background:#27ae60;border-radius:2px;display:inline-block;border-top:2px dashed #27ae60"></span>Quality
                    </span>
                </span>
            </div>
